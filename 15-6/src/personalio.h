...
/**
 * @brief muestra un mensaje y luego queda a la espera del ingreso de un numero entero para luego retornarlo por referencia
 *
 * @param var int*
 * @param mensaje mensaje a mostrar
 * @return 1 if ok, -1 if error
 */
int intScan(int* var, char *mensaje);


/**
 * @brief muestra un mensaje y luego queda a la espera del ingreso de un numero flotante para luego retornarlo por referencia
 *
 * @param var float*
 * @param mensaje mensaje a mostrar
 * @return 1 if ok, -1 if error
 */
float floatScan( float* var, char *mensaje);
